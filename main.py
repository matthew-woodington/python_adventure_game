...
played_kitchen = False
played_hospital = False
played_street = False
...
def play_hospital_room():
    ...
    global played_hospital
    played_hospital = True
...
class Game():
    ...
    def start_room(self):
        ...
        if player.key_fragments == 0:
            ...
            time.sleep(3)
            print(
                "It appears that your only options for escape are the doors. You decide to approach one.")
            time.sleep(3)
        ...
        while True:
            ...
            if choice == 'left':
                ...
                if player.key_fragments < 3:
                    ...
                    time.sleep(3)
                    print(
                        "After a moment, you open eyes and discover you are lying in a hospital bed, surrounded by your friends and family.")
                    time.sleep(3)
