    ...
    def action_directions(self):
        while self.answer == 'incorrect':
            ...
            if direction == 'left':
                ...
                time.sleep(1.5)
                print(
                    "You notices that it was not able to come down. She started to mewo and looked scared.")
                time.sleep(1.5)
                ...
                time.sleep(3)
                print(
                    'Maybe you meet someone you know and have a good time? \n Do you want to go and check  or ignore?')
                self.answer = 'correct'
...
it looks blury you think it have something to do with these empty streets...hummmm? """)
                time.sleep(2)
                print(
                    "There is a picture with the headline there is something familiar to you about it.......")
                time.sleep(2)
...
What will be your first choice?  \nget a ladder  \nclimb the tree?\n""")
    ...
    def action_from_direction(self):
        ...
        if len(self.available_directions) == 2:
            ...
            time.sleep(1)
            self.checker = [self.available_directions[0],
                            self.available_directions[1]]
        else:
            self.checker = [self.available_directions[0],
                            self.available_directions[0]]
